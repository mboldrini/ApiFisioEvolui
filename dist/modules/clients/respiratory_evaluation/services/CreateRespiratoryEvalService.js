...
class CreateClientRespiratoryEvalService {
  async execute({
    ...
    const clientRespEvalRepo = (0, _typeorm.getCustomRepository)(_RespiratoryEval.ClientRespiratoryEvalRepository);
...
var _default = CreateClientRespiratoryEvalService;
